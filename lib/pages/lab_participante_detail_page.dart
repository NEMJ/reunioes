...
class LabParticipanteDetailPage extends StatefulWidget {
  LabParticipanteDetailPage({
    Key? key,
    this.participante,
  }) : super(key: key);
  ...
  @override
  State<LabParticipanteDetailPage> createState() => _LabParticipanteDetailPageState();
}
...
class _LabParticipanteDetailPageState extends State<LabParticipanteDetailPage> {
                        ...
                        children: [
                          ...
                          Flexible(
                            child: DropdownFormFieldWidget(
                              ...
                              validator: true,
                              optionChanged: (escolha) => tipoParticipante = escolha as String,
                            ),
                          ),
                        ],
                      ),
